...
--10.Retrieve the branch numbers and along with the count of employees for branches having more than 2 employees.
...
--11.Retrieve the highest rental price from books table.
    ...
    select * from books where Rental_price in (select max(rental_price) from books)
